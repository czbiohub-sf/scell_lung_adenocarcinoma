...
TH226 TN vs PER
```{r}
# compare naive cells (n = 15) to pr cells (n = 194)
...
TH226 TN vs PD
```{r}
# compare naive cells (n = 15) to pd cells (n = 13)
...
TH226_PERvsPD.1_sig_per <- filter(TH226_PERvsPD.1, avg_logFC > 0 & sig == "p_val_adj<0.05") #52 genes
TH226_PERvsPD.1_sig_pd <- filter(TH226_PERvsPD.1, avg_logFC < 0 & sig == "p_val_adj<0.05") #323 genes
