...
```{r}
tiss_subset@meta.data$"Final_annotation" <- NA
...
```{r}
tiss_subset@meta.data$biopsy_type <- gsub(x = tiss_subset@meta.data$biopsy_type, pattern = "core", replacement = "Core")
tiss_subset@meta.data$biopsy_type <- gsub(x = tiss_subset@meta.data$biopsy_type, pattern = "resection", replacement = "Resection")
# 
Idents(object = tiss_subset) <- tiss_subset@meta.data$biopsy_type
...
mean.N.genes <- aggregate(tiss_subset@meta.data$nFeature_RNA, list(tiss_subset@meta.data$biopsy_type), mean)
# 
