...
```{r}
pdf("/myVolume/sclung_adeno/immune_cell_analysis/plot_out/I03/Myeloid-cells_subclustering_TSNE.pdf",10,10)
# Table 
tab.1 <- table(t.cell.tiss@meta.data$res.0.3, t.cell.tiss@meta.data$analysis)
balloonplot(tab.1, main ="Response vs Biopsy site", xlab ="", ylab="",
            label = T, show.margins = F)
...
# # Write table 
write.table(t.ipa, "/myVolume/sclung_adeno/immune_cell_analysis/data_out/I03/Differentially_expressed_genes_Myeloid_clusters.txt" , row.names = T, quote=F, sep="\t")
```
