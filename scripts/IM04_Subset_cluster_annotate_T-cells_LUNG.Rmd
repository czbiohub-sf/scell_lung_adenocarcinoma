...
```{r}
# Violin
genes <- c("IFNG", "GZMK", "FCGR3A", "KIR2DL3", "KIR2DL4", "IL7R", "CCR7")
a <- VlnPlot(t.cell.tiss,features = genes)
# 
FeatureScatter(t.cell.tiss, feature1 = "FCGR3A", feature2 = "KIR2DL3", group.by = "analysis")
FeatureScatter(t.cell.tiss, feature1 = "FCGR3A", feature2 = "KIR2DL4", group.by = "analysis")

genes <- c("FCGR3A")
a <- VlnPlot(t.cell.tiss,features = genes,group.by = "analysis")
a
```
