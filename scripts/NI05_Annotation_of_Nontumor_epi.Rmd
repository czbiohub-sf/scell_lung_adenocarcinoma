...
```{r}
cell_mutation_tab <- read.csv(file = paste(dir, "Data_input/validationTable_cells.4.19.19.csv", sep = ""))
...
# tumor
tab.2 <- table(tiss_subset_tumor@meta.data$patient_id, tiss_subset_tumor@meta.data$res.0.9)
...
Save object
```{r}
save(tiss_subset_normalepi, file = paste(dir, "Data_input/NI05_normalepi_seurat_object_annotated.RData", sep = ""))
load(file = paste(dir, "Data_input/NI05_normalepi_seurat_object_annotated.RData", sep = ""))
```
...
save(tiss_nonimmune_epi, file = paste(dir, "Data_input/NI05_all_epithelial_annotated_normal_and_tumor.RData", sep = ""))
