...
# Save pdf 
ggsave(clus.tree.out, filename = paste(dir,"plot_out/NI04/Cluster_resolutions_clustree_output.pdf", sep=""), width = 15, height = 15)
clus.tree.out
```
...
```{r}
pdf(file = paste(dir, "plot_out/NI04/tumor_tsne.pdf", sep = ""))
...
# Plot mixing score
pdf(file = paste(dir, "plot_out/NI04/tumor_clusocc_bargraph.pdf", sep = ""))
