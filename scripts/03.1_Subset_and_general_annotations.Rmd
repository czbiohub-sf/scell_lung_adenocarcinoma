...
```{r}
save(tiss_subset, file=paste(dir,"Data_input/objects/S03_Merged_main_filtered_with_neo_osi.RData", sep=""))
```
...
DimPlot(tiss_subset, reduction = "tsne")
```
...
```{r}
# Specify genes  
genes_to_check = c("PTPRC","CD3G","CD3E", "CD79A", "BLNK", "CD68", "CSF1R", "MARCO", "CD207", "EPCAM")
# All on Dotplot 
...
immune_annotation <- c("immune","immune","immune","immune","immune",
                       "non-immune","immune","non-immune","non-immune","immune",
                       "non-immune","immune","non-immune","immune","non-immune",
                       "non-immune","non-immune","immune","immune","non-immune",
                       "immune")
