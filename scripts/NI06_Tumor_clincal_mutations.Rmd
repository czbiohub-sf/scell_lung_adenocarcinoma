...
sub_cell_mutation_tab <- left_join(x = sub_cell_mutation_tab, y = tiss_subset_tumor@meta.data[,c("tumor_seurat_cluster", "cell_id", "patient_id")], by = "cell_id")
# add back rownames
...
# Save Seurat Object
save(tiss_subset_tumor, file = paste(dir, "Data_input/NI04_epithelial_annotated_tumor_mut.RData", sep = ""))
```
