...
sample.ordered <- c(unique(tiss_subset_tumor@meta.data$sample_name[which(tiss_subset_tumor@meta.data$analysis=="naive")]),
unique(tiss_subset_tumor@meta.data$sample_name[which(tiss_subset_tumor@meta.data$analysis=="grouped_pr")]),
unique(tiss_subset_tumor@meta.data$sample_name[which(tiss_subset_tumor@meta.data$analysis=="grouped_pd")]))
# set sample levels
heat.all.mat.m$sample <- factor(heat.all.mat.m$sample, levels=sample.ordered)
# plot
