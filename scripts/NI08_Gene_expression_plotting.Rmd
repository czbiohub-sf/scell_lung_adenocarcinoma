...
DoHeatmap(tiss_subset_tumor2, features = AT2_genes) + scale_fill_gradientn(colors = rev(RColorBrewer::brewer.pal(n = 10, name = "RdBu")))
dev.off()
...
DoHeatmap(tiss_subset_tumor2, features = Plasminogen_genes) + scale_fill_gradientn(colors = rev(RColorBrewer::brewer.pal(n = 10, name = "RdBu")))
dev.off()
...
Kynurenine$Kynurenine_mean <- rowMeans(Kynurenine[c("IDO1", "KYNU")], na.rm=TRUE)
...
DoHeatmap(tiss_subset_tumor2, features = Kynurenine_genes) + scale_fill_gradientn(colors = rev(RColorBrewer::brewer.pal(n = 10, name = "RdBu")))
dev.off()
...
DoHeatmap(tiss_subset_tumor2, features = GJBs_genes) + scale_fill_gradientn(colors = rev(RColorBrewer::brewer.pal(n = 10, name = "RdBu")))
dev.off()
...
```{r}
IGFBP2 <- FetchData(object = tiss_subset_tumor2, vars = c("IGFBP2", "HOPX", "SFTPD", "analysis"))

ggplot(data = IGFBP2, aes(x = analysis, y = IGFBP2)) + geom_boxplot()
ggplot(data = IGFBP2, aes(x = HOPX, y = IGFBP2)) + geom_point()
```
