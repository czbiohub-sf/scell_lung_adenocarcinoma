...
#subset to only 01A tcga samples
table(tcga_samples1$X4) 
...
tcga_samples1$bcr_patient_barcode <- paste(tcga_samples1$X1, tcga_samples1$X2, tcga_samples1$X3, "01A", sep = "-")
...
```{r}
luad_tcga1_AlveolarSig <- left_join(TCGA_Alveolar_mean_f,tcga_meta, by = "bcr_patient_barcode")
...
```{r}
luad_tcga1_Kynurenine <- left_join(TCGA_Kynurenine_mean_f, tcga_meta, by = "bcr_patient_barcode")
...
```{r}
luad_tcga1_Plasminogen <- left_join(TCGA_Plasminogen_mean_f, tcga_meta, by = "bcr_patient_barcode")
...
```{r}
luad_tcga1_Serpine <- left_join(TCGA_Serpine_sig_f, tcga_meta, by = "bcr_patient_barcode")
...
```{r}
luad_tcga1_GapJunction <- left_join(TCGA_GapJunction_mean_f, tcga_meta, by = "bcr_patient_barcode")
