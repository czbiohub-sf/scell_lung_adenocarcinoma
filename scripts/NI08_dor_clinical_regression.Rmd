...
ggp_TN_Alveolar <- ggplot(TN_Alveolar_mean, aes(x = colMeans(TN_Alveolar), y = dor)) + geom_point(aes(color = dor_class)) + geom_smooth(method = "lm")
...
ggp_TN_Kynurenine <- ggplot(TN_Kynurenine_mean, aes(x = colMeans(TN_Kynurenine), y = dor)) + geom_point(aes(color = dor_class)) + geom_smooth(method = "lm")
...
ggp_TN_Plasminogen <- ggplot(TN_Plasminogen_mean, aes(x = colMeans(TN_Plasminogen), y = dor)) + geom_point(aes(color = dor_class)) + geom_smooth(method = "lm")
...
ggp_TN_Serpine1 <- ggplot(TN_Serpine_sig, aes(x = SERPINE1, y = dor)) + geom_point(aes(color = dor_class)) + geom_smooth(method = "lm")
...
ggp_TN_GapJunction <- ggplot(TN_GapJunction_mean, aes(x = colMeans(TN_GapJunction), y = dor)) + geom_point(aes(color = dor_class)) + geom_smooth(method = "lm")
