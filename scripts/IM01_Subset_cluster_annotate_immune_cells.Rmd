...
# Plot 
pdf(paste(dir,"plot_out/IM01/Immune_cells_free_annotation_on_TSNE.pdf", sep=""),10,10)
TSNEPlot(object = tiss_immune, do.label = TRUE, pt.size = 0.5, group.by='immune_subtype_annotation', label.size = 6)
TSNEPlot(object = tiss_immune, do.label = F, pt.size = 0.5, group.by='immune_subtype_annotation', label.size = 6)
dev.off()
```
...
ggsave(paste(dir,"plot_out/IM01/Immune_cell_counts.pdf", sep=""), width = 10, height = 7)
```
