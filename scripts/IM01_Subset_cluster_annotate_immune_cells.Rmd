...
load(file=paste(dir,"Data_input/objects/S03_Immune_Seurat_object_new.RData", sep=""))
tiss_immune
```
...
# Annotate cells 
free_annotation <- c("T-cells","MF-Monocytes", "MF-Monocytes", "B-cells-PB", "B-cells-M", "Neutrophils", "Mast-cells", "MF-Monocytes", "Unknown", "T-cells", "T-cells", "MF-Monocytes", "pDCs", "Dendritic")
...
require(reshape)
# Barplot of patients per cluster 
tab1 <- table(tiss_immune@meta.data$patient_id, tiss_immune@meta.data$SmartSeq2_snn_res.0.3)
# 
tab1 <- melt((apply(tab1, MARGIN = 2, max)/colSums(tab1))*100)
tab1$cell.type <- row.names(tab1)
# # Order 
