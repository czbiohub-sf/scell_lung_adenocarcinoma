...
```{r}
# Violin plot 
genes <- c("IDO1","CXCL9","CXCL10","CXCL11", "GBP1", "GBP5", "ANKRD22", "CD80", "CD86")
a <- VlnPlot(mf.cell.tiss, features.plot = genes, do.return = T)
ggsave(filename = paste(dir, "plot_out/IM04/Markers_of_PD_MFs.pdf",sep=""),plot = a,width = 10,height = 7)
a
```
Plot top genes 
```{r}
