...
ggsave(filename = paste(dir, "plot_out/IM04/MF_TSNE_clusters_by_treatment_manuscript.pdf",sep=""), plot = fraction.plot, width = 7,height = 5)
fraction.plot
...
# Save plot 
ggsave(filename = paste(dir, "plot_out/IM04/MF_TSNE_clusters_by_treatment_with_error_bars_manuscript.pdf",sep=""), plot = p, width = 7,height = 5)
p
```
...
pdf(paste(dir, "plot_out/IM04/Heatmap_markers_of_MFcell_clusters.pdf",sep=""), 7,7)
