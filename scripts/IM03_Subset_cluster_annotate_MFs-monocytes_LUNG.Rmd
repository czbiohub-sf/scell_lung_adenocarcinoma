...
meta.temp$cluster <- mapvalues(meta.temp$SmartSeq2_snn_res.0.3, from=c(0,1,2,3,4,5,6), to=c("MF0", "MF1", "MF2","MF3", "MF4", "MF5", "MF6"))
...
tab.1$cluster <- factor(tab.1$cluster, levels = c("MF0", "MF1", "MF2", "MF3", "MF4", "MF5", "MF6"))
